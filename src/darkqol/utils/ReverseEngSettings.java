...
public class ReverseEngSettings {
    public static final String MOD_ID = "dark_qol";
    ...
    public static int daysNoCore() {
        return getInt("dark_re_days_no_core", 30);
    }

    public static int daysGamma() {
        return getInt("dark_re_days_gamma", 20);
    }

    public static int daysBeta() {
        return getInt("dark_re_days_beta", 15);
    }

    public static int daysAlpha() {
        return getInt("dark_re_days_alpha", 5);
    }

    public static int daysOmega() {
        return getInt("dark_re_days_omega", 2);
    }
    ...
    public static int droneReplicatorDayReduction() {
        return getInt("dark_re_drone_day_reduction", 1);
    }
    ...
    public static float priceMultNoCore() {
        return getFloat("dark_re_price_mult_no_core", 2.0f);
    }

    public static float priceMultGamma() {
        return getFloat("dark_re_price_mult_gamma", 1.6f);
    }

    public static float priceMultBeta() {
        return getFloat("dark_re_price_mult_beta", 1.0f);
    }

    public static float priceMultAlpha() {
        return getFloat("dark_re_price_mult_alpha", 0.4f);
    }

    public static float priceMultOmega() {
        return getFloat("dark_re_price_mult_omega", 0.0f);
    }
    ...
    public static boolean debugLogging() {
        return getBoolean("dark_re_debug_logging", false);
    }
}
